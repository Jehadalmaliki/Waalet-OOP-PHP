...
<body style="background-image: linear-gradient(to right, #fc5c7d, #6a82fb);">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <div class="text-end">
                    ...
                    <?php } elseif ( empty($_SESSION) || empty($_SESSION['userID']) ) { ?>
                        <a href="login.php" class="btn btn-outline-light me-2" style="background-image: linear-gradient(to right, #fc5c7d, #6a82fb);">Login</a>
                        <a href="register.php" class="btn btn-success" style="background-image: linear-gradient(to right, #fc5c7d, #6a82fb);">Sign-up</a>
                    <?php } ?>
                </div>
            </div>
        </div>
